...
of this collection checkout link:http://bradyhouse.io[bradyhouse.io].  For my notes from studies @ IIT visit
link:http://iit.bradyhouse.ai[iit.bradyhouse.ai]. Or checkout my current focus, AWS Certification, @ link:http://aws.bradyhouse.ai[aws.bradyhouse.ai].
