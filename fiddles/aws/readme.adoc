...
||link:vpc/vpc-nat-inst-and-gateways.md[VPC NAT Instances & NAT Gateways]
||link:https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Subnets.html[VPCs and Subnets]
|=========================================================
