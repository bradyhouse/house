...
while watching lectures/labs on link:http://acloud.guru[acloud.guru]. Aside from purchasing the
AWS Certified Solutions Architect - Associate course on cloud guru, all of my studies have been
done using an [AWS free tier account](https://aws.amazon.com/free/).
