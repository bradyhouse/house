...
|link:https://github.com/bradyhouse/house/blob/master/fiddles/aws/whitepapers/white-papers-best-practices#best-practices-flash-cards[image:https://i.imgur.com/torRcHV.png["Flash Cards",width=16]]|link:whitepapers/whitepapers-best-practices.md[White Papers - Best Practices]
||link:whitepapers/whitepapers-waf-intro.md[White Papers - Well Architected Framework (Intro)]
