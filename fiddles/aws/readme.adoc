...
be imported into the iFlash Mac desktop app as a _Card Deck__. The deck can then pushed to your Ipad or Iphone
using the __iFlash Touch__ app. Usin the approach, the __Study Workflow__ then becomes:
