...
== Getting Through BIO 101 ...

AWS certification in many ways, is like a _god-awful_ pre-med biology class. You gotta memorize some things cold so you
will then be ready to use it to navigate confusing word problems and multiple choice questions. __What to do?__ In my
experience, there is only one way to get through BIO 101: __flash cards__.  Fortunately, today there is an App for
...
using the __iFlash Touch__ app. Using the approach, the __Study Workflow__ then becomes:
