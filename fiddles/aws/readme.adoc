...
In my experience, recent graduation @ 40 from IIT, there is only one way to get some of this stuff to stick in your
head-- flash cards.  Fortunately, today there is an App for that-- __iFlash__ Desktop App and it's companion mobile
app __iFlash Touch__.
