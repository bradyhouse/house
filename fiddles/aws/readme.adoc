...
In case you find downloading, importing and exporting each of the flashcard deck a bit tedious, here is the complete
collection combined into one massive, categorized deck of 400+ flash cards.  This is the deck I used going into
the Exam.  Additionally, it includes some of the more extraneous practice exam questions included in the
Acloud.guru mini exam section.

[cols="m", width="100%"]
|=========================================================
|**link:https://github.com/bradyhouse/house/blob/master/fiddles/aws/flashcards/AWS%20Solutions%20Architect%20Exam%20(July%202018).zip[Complete Flashcard Deck]**
|=========================================================

To download the `Complete flashcard` deck, right click the above link and select `Save Link As...`.
