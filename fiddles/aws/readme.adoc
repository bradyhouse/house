...
|link:https://github.com/bradyhouse/house/blob/master/fiddles/aws/whitepapers/whitepapers-waf-ops-excellence.md#well-architected-framework-ops-excellence-flash-card-deck[image:https://i.imgur.com/torRcHV.png["Flash Cards",width=16]]|link:whitepapers/whitepapers-waf-ops-excellence.md[White Papers - Well Architected Framework (Operational Excellence)]
