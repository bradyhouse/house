...
|link:https://github.com/bradyhouse/house/blob/master/fiddles/aws/exam-tips/exam-tips-resource-groups.md#flash-cards[image:https://i.imgur.com/torRcHV.png["Flash Cards",width=16]]|link:exam-tips/exam-tips-resource-groups.md[Additional Exam Tips - Resource Groups]
|=========================================================
