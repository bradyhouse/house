...
||links:https://docs.aws.amazon.com/apigateway/latest/developerguide/welcome.html[White Paper - What is API Gateway]
||links:apps/apps-kinesis-101.md[Apps: Kinesis 101]
||links:apps/apps-kinesis-lab.md[Apps: Kinesis Lab]
|=========================================================
