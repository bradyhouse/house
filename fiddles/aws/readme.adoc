...
image:https://i.imgur.com/torRcHV.png["Just Memorize Indicator",width=128]
...
|=========================================================
2+>| **Intro**|
||link:overview.md[10,000 Foot Overview] image:https://i.imgur.com/torRcHV.png["Just Memorize Indicator",width=16]
