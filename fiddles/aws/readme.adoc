...
This means that include an additional `Review Question and Answer` section and an `iFlash Card` formatted
file. These files can be imported the into the `iFlash Card` desktop App and then published to an iphone or ipad
