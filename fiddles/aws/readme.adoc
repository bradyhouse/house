...
||link:https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_SecurityGroups.html[Security Groups for Your VPC]
...
||link:https://www.lucidchart.com[Apps - Lucid Charts (AWS VPC Network Diagramming Tools)]
2+>| **Application Services**
||link:apps/apps-sqs-101.md[Application Services: Simple Que Service 101]
