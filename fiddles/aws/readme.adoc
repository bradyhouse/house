...
distinction the markdown file link is designated with the image:https://i.imgur.com/torRcHV.png["Just Memorize Indicator",width=16] emoji.
This means that my notes include an additional an `iFlash Card` formatted file based on the material covered. These files
can be imported the into the `iFlash Card` desktop App and then published to an iphone or ipad for `on-the-go` review.
For more information see the xref:Memorization-Strategy[Flash Card Strategy Section] below.
...
|=========================================================
2+>| **Intro**
|image:https://i.imgur.com/torRcHV.png["Just Memorize Indicator",width=20]|link:overview.md[10,000 Foot Overview]
...
4.  Go through the cards as you review of the material covered
