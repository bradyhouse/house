...
2+>| **Additional Exam Tips**
|link:https://github.com/bradyhouse/house/blob/master/fiddles/aws/exam-tips/exam-tips-feedback.md#well-architected-framework-exam-tips---student-feedback-flash-card-deck[image:https://i.imgur.com/torRcHV.png["Flash Cards",width=16]]|link:exam-tips/exam-tips-feedback.md[Additional Exam Tips - Student Feedback]
|=========================================================
