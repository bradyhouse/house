...
const RichGrid = forwardRef((props, ref) => {
  ...
  const [isToolPanel] = useState(false);
  ...
  const onSubNavShowSkillsColumn = (state) => {
    gridColumnApi.setColumnVisible('skills', state);
  };
  ...
  if (showGrid) {
    return (
      <div data-testid="show-grid-dom" style={{ width: '100%', height: window.innerHeight - 200, paddingTop: '15px' }}>
            <SubNav
              rowCount={rowCount}
              showGrid={showGrid}
              ...
              onShowSkillsColumn={onSubNavShowSkillsColumn}
    ...
    return (
      <div data-testid="hide-grid-dom" style={{ width: '100%', height: window.innerHeight - 50, paddingTop: '15px' }}>
            <SubNav
              showGrid={showGrid}
              rowCount={rowCount}
              onQuickFilterChanged={onSubNavQuickFilterChanged}
              ...
              onSelectAll={onSubNavSelectAll}
              onClearSelection={onSubNavClearSelection}
              onShowCountryColumn={onSubNavShowSkillsColumn}>
          </SubNav>
