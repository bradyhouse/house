      ...
      <div>
        ...
        <div className="content" tabIndex="-1" role="group">
          <figure className="figure">
            <svg id="figure1">
              <image id="48"
                     xlinkHref="images/0048-release.jpg"
                     width="105" height="140" x="0" y="0" opacity="1"
                     onClick={() => this.openModal("48","images/0048-release.jpg")}
                     >
              ...
              <image id="49"
                     xlinkHref="images/0049-release.jpg"
                     width="105" height="140" x="-88" y="0" opacity="1"
                     onClick={() => this.openModal("49","images/0049-release.jpg")}
              >
              ...
              <image id="50"
                     xlinkHref="images/0050-release.jpg"
                     width="105" height="140" x="-176" y="0" opacity="1"
                     onClick={() => this.openModal("50","images/0050-release.jpg")}
              >
              ...
              <image id="51"
                     xlinkHref="images/0051-technique.jpg"
                     width="105" height="140" x="-264" y="0" opacity="1"
                     onClick={() => this.openModal("51","images/0051-technique.jpg")}
              >
              ...
              <image id="52"
                     xlinkHref="images/0052-design.jpg"
