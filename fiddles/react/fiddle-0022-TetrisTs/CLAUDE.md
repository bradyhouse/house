...
A **react** fiddle — a throwaway sandbox for exploring one idea, scaffolded and
managed with [fiddle](https://github.com/hetalhouse/fiddle).

## Run it
```bash
fiddle start react fiddle-0022-TetrisTs     # or, from here: npm run dev
```
...
- `fiddle publish` builds it and integrates it into the portfolio **automatically**
  ...
  plumbing in here.
- Iterate by `fiddle fork react fiddle-0022-TetrisTs` rather than editing a "known-good" fiddle.
