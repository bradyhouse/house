    ...
    function barChart() {
        ...
        function renderBars() {
            ...
            _bodyG.selectAll("rect.bar")
                .data(_data)
                .on('mouseover', (d, i) => {
                    let left = i <= 28 ? 55 + x(d.label) : 55 + x(_data[28].label),
                        top = d.y < 0 ? y(0) + 5 : y(0) + 45;
                    showTooltip(d, left, top);
                })
                .on('click', (d, i) => {
        ...
        function showTooltip(d, left, top) {
