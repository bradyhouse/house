...
Executing the command `./fiddle.sh "refactor" "tween" "0000" "fiddle-0100-Refactor"` from the `scripts` directory produces
...
Note, when an `tween` fiddle is `refactored`, the `fiddle.sh index tween` command is automatically initiated.  This 
