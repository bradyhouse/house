  ...
  private _applyChange(item: any): void {
    switch (item.key) {
      ...
      case 'height':
        ...
        this._resize();
        break;
      case 'sparkLineRender':
        console.log('configuring sparkLine...');
        this._gridOptions.enableAsyncPostRender = true;
        this._nodesService.configureSchema(this.options.sparkLineRender);
        break;
    }
  }
