...
export interface TreeGridInterface {
  ...
  /**
   * Promise used to inject nodes into a childless node.
   * NOTE - a childless node one with an empty `children` collection.
   */
  ...
  /**
   * Optional setting that can be used to enable node level SparkLine rendering.
   */
  sparkLineRender?: Function;
