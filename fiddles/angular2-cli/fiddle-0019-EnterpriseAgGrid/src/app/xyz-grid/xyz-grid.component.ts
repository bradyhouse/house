...
@Component({
  selector: 'app-xyz-grid',
  templateUrl: './xyz-grid.component.html',
  styleUrls: ['./xyz-grid.component.css'],
  encapsulation: ViewEncapsulation.None

})
export class XyzGridComponent {
  ...
  private countryCellRenderer(params) {
    const flag: string = '<img border="0" width="15" height="10" style="margin-bottom: 2px" src="https://www.ag-grid.com/images/flags/' +
