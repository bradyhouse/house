...
var AppComponent = (function () {
    ...
    AppComponent.prototype._render = function () {
        var _this = this;
        var alphabet = 'abcdefghijklmnopqrstuvwxyz', columns = alphabet.split('').map(function (l, i) {
            return {
                id: l,
                field: l,
        ...
        }), _columnFilters = {}, filter = function (item) {
            for (var columnId in _columnFilters) {
                if (columnId !== undefined && _columnFilters[columnId] !== "") {
                    var c = _this._grid.getColumns()[_this._grid.getColumnIndex(columnId)];
