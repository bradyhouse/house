...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onRangeSelectionChanged = function ($event) {
        this.captureCellRange();
    };
    AppComponent.prototype.chartGroupedBar = function () {
    ...
    AppComponent.prototype.chartStackedBar = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
    ...
    AppComponent.prototype.chartNormalizedBar = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
    ...
    AppComponent.prototype.chartGroupedColumn = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
    ...
    AppComponent.prototype.chartStackedColumn = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
    ...
    AppComponent.prototype.chartNormalizedColumn = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
    ...
    AppComponent.prototype.chartArea = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
            chartType: "area"
        };
    ...
    AppComponent.prototype.chartStackedArea = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
    ...
    AppComponent.prototype.chartNormalizedArea = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
    ...
    AppComponent.prototype.chartDoughnut = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
            chartType: "doughnut"
        };
    ...
    AppComponent.prototype.chartLine = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
            chartType: "line"
        };
    ...
    AppComponent.prototype.chartScatter = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
            chartType: "scatter"
        };
    ...
    AppComponent.prototype.chartPie = function () {
        var chartRangeParams = {
            cellRange: this.cellRange,
            chartType: "pie"
        };
    ...
    AppComponent.prototype.processChartOptions = function (params) {
    ...
    AppComponent.prototype.captureCellRange = function () {
        var _ranges = this.gridApi.getCellRanges();
        var _columns = [];
        var _rowStartIndex;
        var _rowEndIndex;
        if (_ranges.length === 1 && _ranges[0].columns[0].colId === 'country') {
            ...
            _ranges[0].columns.forEach(function (column) {
    ...
    AppComponent.prototype.updateBtnBar = function (id) {
        if (id === void 0) { id = null; }
        var btnsDiv = document.getElementById('btnBar');
        var btns = btnsDiv.querySelectorAll('button');
        var activeBtn = id ? document.getElementById(id) : null;
        var activeBtnCls = activeBtn ? activeBtn.getAttribute('class') : null;
        if (btns) {
    ...
    AppComponent.prototype.displayChart = function (chartRangeParams, btnId) {
        if (this.chartRef) {
    ...
    AppComponent.prototype.attachCloseHandler = function () {
        var _this = this;
        var closeBtn = this.chartRef.chartElement.querySelector('.chart-wrapper-close');
        console.debug(closeBtn);
        if (closeBtn) {
            closeBtn.addEventListener('click', function () {
                _this.chartRef.destroyChart();
                _this.updateBtnBar();
            });
        }
    };
...
module.exports = __webpack_require__(/*! /Users/bradyhouse/github/house_master/fiddles/angular2-cli/fiddle-0027-EntAgGridChart/src/main.ts */"./src/main.ts");
