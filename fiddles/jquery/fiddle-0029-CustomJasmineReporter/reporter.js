...
House.Boot = House.Boot || (function(emptyFn) {
    var doc = document,
        ...
        Boot = {
            ...
            // eg, when House.require(...) is called
            syncMode: false,
            /*
            ...
            /*
             * this is a helper function used by House.Loader to flush out
 ...
 * @method
 */
House.globalEval = House.globalEval || (this.execScript ? function(code) {
    execScript(code);
} : function($$code) {
