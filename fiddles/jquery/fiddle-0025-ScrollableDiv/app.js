        ...
        render: function(target) {
            var viewport = new Container({
                ...
                rendered: function(viewport, frame, content) {
                    content.self.append('<iframe src="http://bradyhouse.github.io" style="width: 100%; height: 700px;” scrolling="no" marginwidth="0" marginheight="0" frameborder="0" vspace=“0” hspace=“0”/>');}
            });
        },
        init: function() {
            var hook = $('#fiddleHook');
