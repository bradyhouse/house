(function (app, $, undefined) {
  ...
  app.view = app.view || {
    ...
    renderThermometer: function () {
      ...
      this.canvas.clear();
      this.manicusCoords = this.calcCoors();
      ...
      let canvas = this.canvas,
        ...
        manicusLabel = Thermometer.manicusLabel(this.isEditMode, this.fontFamily, this.manicusLevel.top, this.textColor,
          this.formatDollarAmt(this.deltaDonations)),
        manicus = Thermometer.manicus(this.manicusLevel.top, this.manicusLevel.height, this.innerColor),
