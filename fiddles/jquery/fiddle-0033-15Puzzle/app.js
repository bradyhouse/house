(function(app) {
    ...
    app.metadata = app.metadata || {
        gitHubUrl: 'https://github.com/bradyhouse/house/tree/master/fiddles/jquery/fiddle-0033-NumberPuzzle',
        ...
        load() {
            ...
            if (this.data.length === 0) {
                ...
                for (; row <= this.rows; row++) {
                    ...
                    if (row == 1) {
                        btnGroupElement.setAttribute('style', 'background-color: #2196F3; padding-top: 5px; padding-left: 5px; padding-right: 5px;');
                    } else if (row == this.rows) {
                        btnGroupElement.setAttribute('style', 'background-color: #2196F3; padding-bottom: 5px; padding-left: 5px; padding-right: 5px;');
                    } else {
                        btnGroupElement.setAttribute('style', 'background-color: #2196F3; padding-left: 5px; padding-right: 5px;');
                    }
