...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        d3__WEBPACK_IMPORTED_MODULE_9__["csv"]("./assets/data.csv").then(function (rawData) {
            var data = rawData.map(function (datum) { return ({
                x: +new Date(datum.Date || 0),
                y: +(datum['Adj Close'] || 0)
            }); });
            _this._createNumericLineChart(data);
        });
    };
    //#endregion
    AppComponent.prototype._createNumericLineChart = function (data) {
        var chart = new ag_grid_enterprise_dist_lib_charts_chart_cartesianChart__WEBPACK_IMPORTED_MODULE_2__["CartesianChart"]({
        ...
        chart.xAxis.labelFormatter = function (params) {
        ...
        var lineSeries = new ag_grid_enterprise_dist_lib_charts_chart_series_lineSeries__WEBPACK_IMPORTED_MODULE_4__["LineSeries"]();
        ...
        var fit = Object(ag_grid_enterprise_dist_lib_charts_util_stat__WEBPACK_IMPORTED_MODULE_8__["linearRegression"])(X, Y);
        if (fit) {
            ...
            var slopeSeries = new ag_grid_enterprise_dist_lib_charts_chart_series_lineSeries__WEBPACK_IMPORTED_MODULE_4__["LineSeries"]();
