Ext.onReady(function () {
    ...
    var fiddleHeader = 'Extreme Fiddle ~ Big Tree Accordion',
        fiddleSubHeader = '<i>Fiddle exploring what happens when two big trees are combined using an Accordion.</i>';
