var fiddleHeader = 'Fiddle ~ Extend Ext.tip.ToolTip',
    fiddleSubHeader = '<i>Fiddle forked from <a href="https://fiddle.sencha.com/#fiddle/ntt" target="_blank">Grid Record Tooltip</a>.  This version explores creating a class that extends the <a href="http://docs.sencha.com/extjs/5.1/5.1.0-apidocs/#!/api/Ext.tip.ToolTip" target="_blank">Ext.tip.ToolTip class</a> using an MVVM approach. </i>';
