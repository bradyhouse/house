Ext.onReady(function() {
    ...
    Ext.define('MyFiddle.view.SearchBarViewModel', {
        extend: 'Ext.app.ViewModel',
        alias: 'viewmodel.searchbar',
        fields: [{
            name: "text",
            convert: undefined
        }]
    });
    Ext.define('MyFiddle.view.SearchBarViewController', {
        extend: 'Ext.app.ViewController',
        alias: 'controller.searchbar'
    });
    Ext.define('MyFiddle.view.SearchBar', {
        extend: 'Ext.toolbar.Toolbar',
        requires: [
            'MyFiddle.view.SearchBarViewModel',
            'MyFiddle.view.SearchBarViewController'
        ],
            ...
            return [{
                ...
                triggers: {
                    search: {
                        ...
                        handler: 'onSearchBarTriggerClick'
                    }
                },
                listeners: {
                    change: function() {
    ...
    Ext.define('MyFiddle.view.TreeBaseClass', {
        ...
        requires: ['MyFiddle.StateManager', 'MyFiddle.view.SearchBar'],
        rootVisible: false,
        collapseFirst: true,
        useArrows: true,
