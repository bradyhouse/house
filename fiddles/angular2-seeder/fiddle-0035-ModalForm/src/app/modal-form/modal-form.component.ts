...
@Component({
    selector: 'modal-form',
    styleUrls: ['./app/modal-form/modal-form.component.css'],
    templateUrl: './app/modal-form/modal-form.component.html',
...
export class ModalFormComponent {
    ...
    get height():number {
        return this.options && this.options.items && this.options.items.length ?
        this.options.items.length * 21 : 100;
    }
