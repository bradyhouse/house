 ...
 */
function paginateFilteredItems(items, criteria = {}, pageNumber = 1, pageSize = 50) {
...
module.exports.pagesPOST = function (req = null) {
    logger.log(req);
    return new Promise((resolve) => {
        const response = paginateFilteredItems(pagesStore.items(),
           req.searchCriteria,
           req.pageNumber,
           50 
        );
