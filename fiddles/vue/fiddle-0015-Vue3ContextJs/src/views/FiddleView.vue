    ...
    <div class="h-100 d-flex align-items-center justify-content-center">
        <table width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div style="width: 500px;" ref="plotlyChart1" @contextmenu.prevent="onRightClick"></div>
                    </td>
                    <td>
                        <div style="width: 500px;" ref="plotlyChart2" @contextmenu.prevent="onRightClick"></div>
                    </td>
                    <td>
                        <div style="width: 1000px !important; height: 1000px !important;" ref="plotlyChart3" @contextmenu.prevent="onRightClick"></div>
                    </td>
                </tr>
...
<ContextMenu ref="contextMenu" :actions="contextMenuActions" @action-clicked="handleActionClick" />
