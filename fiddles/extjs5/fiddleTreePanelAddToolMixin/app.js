Ext.onReady(function () {
    ...
    Ext.define('MyFiddle.view.AnimalTree', {
        ...
        requires: [
            'MyFiddle.view.AnimalTreeController'
        ],
        mixins: {
    ...
    Ext.define('MyFiddle.view.PeopleTreeController', {
        extend: 'Ext.app.ViewController',
        alias: 'controller.peopletree',
        onExcelExport: function () {
            console.log('onExcelExport');
    ...
    Ext.define('MyFiddle.view.PeopleTree', {
        extend: 'MyFiddle.view.TreeBaseClass',
        requires: [
            'MyFiddle.view.PeopleTreeController'
        ],
        alias: 'widget.tree-people',
        mixins: {
            excelexport: 'MyFiddle.ExcelExport'
        },
        controller: 'peopletree',
        listeners: {
            excelexport: 'onExcelExport'
        },
        initComponent: function () {
