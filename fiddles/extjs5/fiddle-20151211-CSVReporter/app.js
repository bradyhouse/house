var meta = {
    ...
    fiddleSubHeader: 'Pen exploring how to dynamically (a) bind a CSV file to a grid and (b) provide filtering ' +
    'controls based on it\'s schema.  Additionally, this pen illustrates how to integrate ' +
    'external libraries with ExtJS. Jquery-CSV is used to parse the CSV. Finally, for some <i>extra bling</i> the ' +
    'ExtJS Aria theme is in play. <br/><br/>',
    urls: {
        a: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/297733/report-a.csv',
        b: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/297733/report-b.csv'
    }
};
