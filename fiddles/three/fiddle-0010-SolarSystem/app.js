// Bootstrap the `app` namespace this fiddle hangs its toolkit/view modules off of
// (it uses `app.x = app.x || {}` throughout but never declared `app` itself, so it
// threw "app is not defined" before the scene ever built). 2026-08-13.
var app = window.app || {}
