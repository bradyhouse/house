(function(app) {
    ...
    var meta = {
        urls: {
            earth: {
                reliefMaterial: 'resources/images/earth.jpg',
                surfaceMaterial: 'resources/images/atmosphere.jpg',
                atmosphereMaterial: 'resources/images/clouds.png'
            },
                            ...
                            loader.load(
                                ...
                                function(texture) {
                                    ...
                                    loader.load(
                                        meta.urls.moon,
                                        function(texture) {
                                            moonSurfaceMaterial = new THREE.MeshPhongMaterial({
                                                map: texture
                                            });
