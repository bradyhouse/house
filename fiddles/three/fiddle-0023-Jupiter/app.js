(function(app) {
    ...
    let metadata = {
        urls: {
            github: 'https://github.com/bradyhouse/house/tree/master/fiddles/three/fiddle-0023-Jupiter',
          jupiter: {
    ...
    app.view.milkyway.jupiter = app.view.milkyway.jupiter || {};
    ...
    app.test = window.location.pathname.match('test') ? app.test || {
        ...
        jupiter: function(config) {
            return new app.view.milkyway.Jupiter(config);
        }
    } : null;
