...
Executing the command `./fiddle.sh "refactor" "svg" "0000" "fiddle-0100-Refactor"` from the `scripts` directory produces
...
Note, when an `svg` fiddle is `refactored`, the `fiddle.sh index svg` command is automatically initiated.  This 
